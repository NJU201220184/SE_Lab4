...
string random_string_input(string str)
{
    ...
    {
        random_input += random_char_input();
    }

    return random_input;
}

void Input_generator::generate_input()
{
    ...
    while (ifs >> str)
    {
        ...
        if(str.find("int") != -1)
        {
            ...
            input += random_integer_input(str);
            input += ' ';
        }
